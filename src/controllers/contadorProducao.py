...
cod_ordemProducao = sys.argv[1]
cod_funcionario = sys.argv[2]
cod_maquina = sys.argv[3]

print("cod_ordemProducao: " + sys.argv[1]) 
print("cod_funcionario: " + sys.argv[2])
print("cod_maquina: " + sys.argv[3])
...
cap = cv2.VideoCapture("producao10.mp4")
...
while 1:
    ...
    for cnt in contours:
        ...
        if int(area) > 100 :
            ...
            cv2.rectangle(frame,(x,y),(x+w,y+h),(0,255,0),2)
                ...
                #print(centro) - VALOR DE X
                #print(centro[1]) - VALOR DE Y
    ...
    if len(contours) == 0:
        ...
        for detect in detects:
            ...
            for (cod,posicao) in enumerate(detect):
                ...
                print("detect: ",detect)
                print("cod: ",cod,"posicao: ",posicao)
                print(detect[cod-1][1])
                print(posicao[1])
                ...
                if detect[cod-1][0] < posL and posicao[0] > posL :
                    ...
                    #SE PASSOU DA DIREITA PARA ESQUERDA
                if detect[cod-1][0] > posL and posicao[0] < posL:
                    detect.clear()
                    esquerda+=1
                        #total+=1
    ...
    cv2.putText(frame, "TOTAL: "+str(total), (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255),2)
        # cv2.putText(frame, "DIREITA: "+str(direita), (10, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0),2)
        # cv2.putText(frame, "ESQUERDA: "+str(esquerda), (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255),2)
